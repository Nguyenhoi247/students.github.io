...
<div class="container">
  ...
  <form action ="{{url('update/' .$users->id ) }}" method = "POST" class="form-group" style="width:70%; margin-left:15%;">
  @csrf
  ...
  <select class="form-control" value="{{$users->city_name}}" name="city_name">
